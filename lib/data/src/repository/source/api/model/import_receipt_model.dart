class ImportReceiptModel {
  ...
  final List<ImportReceiptItemModel> items;
...
class ImportReceiptItemModel {
  const ImportReceiptItemModel({
    required this.name,
    required this.code,
    required this.unit,
  ...
  ImportReceiptItemModel copyWith({
    String? name,
    String? code,
    String? unit,
