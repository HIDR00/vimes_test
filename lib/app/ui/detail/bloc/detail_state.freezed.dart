...
abstract class $DetailStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, String messenger, Document? document});
}
...
class _$DetailStateImpl implements _DetailState {
  const _$DetailStateImpl(
      {this.isLoading = false, this.messenger = '', this.document});
  ...
  @override
  String toString() {
    return 'DetailState(isLoading: $isLoading, messenger: $messenger, document: $document)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, messenger, document);
...
abstract class _DetailState implements DetailState {
  const factory _DetailState(
      {final bool isLoading,
      final String messenger,
      final Document? document}) = _$DetailStateImpl;
